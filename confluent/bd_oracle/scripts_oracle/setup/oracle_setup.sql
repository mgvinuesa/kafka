...
CREATE TABLE C##MYUSER.ORDER_DATA(ORDERID INTEGER NOT NULL PRIMARY KEY,ORDERDATE TIMESTAMP NOT NULL,CUSTOMERID INTEGER,AMOUNT NUMERIC(6,2) NOT NULL,CONSTRAINT CUSTID FOREIGN KEY(CUSTOMERID) REFERENCES C##MYUSER.CUSTOMER(CUSTOMERID))tablespace USERS;
...
INSERT INTO C##MYUSER.ORDER_DATA VALUES(51, TO_TIMESTAMP('2/3/2005 00:00:00') ,101,3250.25);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(52,TO_TIMESTAMP('3/4/2005 00:00:00'),101,2751.2);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(53,TO_TIMESTAMP('4/5/2005 00:00:00'),101,2250.99);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(54,TO_TIMESTAMP('3/3/2005 00:00:00'),101,2499);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(55,TO_TIMESTAMP('4/4/2005 00:00:00'),102,2952.05);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(56,TO_TIMESTAMP('5/5/2005 00:00:00'),102,2851.74);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(57,TO_TIMESTAMP('3/4/2005 00:00:00'),103,5848);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(58,TO_TIMESTAMP('4/5/2005 00:00:00'),103,1853.75);
INSERT INTO C##MYUSER.ORDER_DATA VALUES(59,TO_TIMESTAMP('5/6/2005 00:00:00'),103,6198.99);
